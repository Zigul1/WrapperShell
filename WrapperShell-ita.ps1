...
[System.Windows.Forms.Label]$intro = @{
    Text = "Questo script genera il file 'carrier.ps1', che può contenere testo (a destra) e un'immagine (a
sinistra). Il file può essere protetto con password (cifratura AES 256) e può autodistruggersi.
Si possono personalizzare gli elementi del file usando il riquadro in basso."
    Font = "Verdana, 11"
...
[System.Windows.Forms.Label]$Img = @{
    Text = "Scegliere l'immagine da inserire a sinistra (facoltativa)"
    Font = "Verdana, 11"
...
Function FileImg ($InitialDirectory) {
    ...
    $OpenFileDialog.Title = "Scegliere un'immagine"
    $OpenFileDialog.InitialDirectory = $InitialDirectory
    $OpenFileDialog.filter = “All files (*.*)| *.*”
    If ($OpenFileDialog.ShowDialog() -eq "Cancel") {
        [System.Windows.Forms.MessageBox]::Show("Nessun file selezionato", "Avviso", 0,
...
[System.Windows.Forms.Label]$txt = @{
    Text = "Scegliere il testo da inserire a destra (facoltativo); eventualmente attivare scrollbar (v. sotto)"
    Font = "Verdana, 11"
...
[System.Windows.Forms.Label]$LabelSave = @{
    Text = "Scegliere dove salvare 'carrier.ps1'"
    Font = "Verdana, 11"
...
[System.Windows.Forms.CheckBox]$CheckBoxS = @{
    Text = " Proteggi 'carrier.ps1' con una password (> 6 caratteri):"
    Font = "Verdana, 11"
    BackColor = "#31694b"
    AutoSize = $true
...
[System.Windows.Forms.CheckBox]$CheckBoxD = @{
    Text = " Autodistruggi 'carrier.ps1' dopo              secondi dalla sua esecuzione"
    Font = "Verdana, 11"
    BackColor = "#46110b"
    AutoSize = $true
...
$stext.Location = New-Object System.Drawing.Point(280,380)
...
[System.Windows.Forms.Label]$LabelC = @{
    ...
    AutoSize = $true
    BackColor = "#716a45"
    Text = " PERSONALIZZAZIONE ELEMENTI"
}
$main_form.Controls.Add($LabelC)

[System.Windows.Forms.Button]$InfoButton = @{
    Location = New-Object System.Drawing.Point(270,498)
...
- I colori in HEX devono avere il formato #123456
- Se il testo non viene visualizzato completamente nella sezione di destra, è possibile attivare la barra di scorrimento (scrollbar)
- Se si desidera inserire solo una immagine (anche GIF) o solo del testo, bisogna inserire 100 nella rispettiva percentuale e 0 nell'altra (non lasciarla vuota)
- Il codice dei pulsanti, essendo in un'unica riga, deve avere ";" come separatore fra le righe di codice
- I pulsanti fanno parte della sezione del testo (destra), non compariranno se si utilizza un'immagine che riempie tutta la finestra
...
[System.Windows.Forms.Label]$Label0 = @{
    ...
    AutoSize = $true
    Text = "Dimensioni finestra: larghezza           px - altezza           px (default 800 x 400)"
}
$Panel.Controls.Add($Label0)

$winW = New-Object System.Windows.Forms.TextBox
$winW.Location = New-Object System.Drawing.Point(215,8)
...
$winH.Location = New-Object System.Drawing.Point(350,8)
...
[System.Windows.Forms.Label]$Label1 = @{
    ...
    AutoSize = $true
    Text = "Finestra: colore sfondo (HEX)                - colore testo               -  SCROLLBAR        "
}
$Panel.Controls.Add($Label1)

$winC = New-Object System.Windows.Forms.TextBox
$winC.Location = New-Object System.Drawing.Point(215,38)
...
$radioButton1.Location = New-Object System.Drawing.Point(555,38)
...
$radioButton2.Location = New-Object System.Drawing.Point(590,40)
...
[System.Windows.Forms.Label]$Label2 = @{
    ...
    AutoSize = $true
    Text = "Dimensioni in % sezione sinistra (immagine)         e sezione destra (testo)         (default 50 - 50)"
}
$Panel.Controls.Add($Label2)

$imP = New-Object System.Windows.Forms.TextBox
$imP.Location = New-Object System.Drawing.Point(315,68)
...
$teP.Location = New-Object System.Drawing.Point(525,68)
...
[System.Windows.Forms.CheckBox]$box1 = @{
    ...
    AutoSize = $true
    Text = "Inserisci pulsante 1: colore sfondo (HEX)                - colore testo               - testo        "
}
$Panel.Controls.Add($box1)

$b1b = New-Object System.Windows.Forms.TextBox
$b1b.Location = New-Object System.Drawing.Point(302,98)
...
[System.Windows.Forms.Label]$Label4 = @{
    ...
    AutoSize = $true
    Text = "Funzione pulsante 1 (codice PowerShell):"
}
...
Function File1PS1 ($InitialDirectory) {
    $OpenFileDialog = New-Object System.Windows.Forms.OpenFileDialog
    $OpenFileDialog.Title = "Scegliere uno script PS1"
    $OpenFileDialog.InitialDirectory = $InitialDirectory
    $OpenFileDialog.filter = “PS1 files (*.ps1)|*.ps1”
    If ($OpenFileDialog.ShowDialog() -eq "Cancel") {
        [System.Windows.Forms.MessageBox]::Show("Nessuno script selezionato", "Errore", 0,
        [System.Windows.Forms.MessageBoxIcon]::Exclamation) | Out-Null
...
[System.Windows.Forms.CheckBox]$box2 = @{
    ...
    AutoSize = $true
    Text = "Inserisci pulsante 2: colore sfondo (HEX)                - colore testo               - testo        "
}
$Panel.Controls.Add($box2)

$b2b = New-Object System.Windows.Forms.TextBox
$b2b.Location = New-Object System.Drawing.Point(302,182)
...
[System.Windows.Forms.Label]$Label6 = @{
    ...
    AutoSize = $true
    Text = "Funzione pulsante 2 (codice PowerShell):"
}
...
[System.Windows.Forms.Button]$Script2 = @{
    Location = New-Object System.Drawing.Point(620,235)
    Size = New-Object System.Drawing.Size(90,25)
    Text = "Usa PS1"
    Font = "Verdana, 10"
    BackColor = "#101c28"
...
[System.Windows.Forms.Label]$LabelS2 = @{
    Font = "Verdana, 11"
    Location = New-Object System.Drawing.Point(10,233)
    Size = New-Object System.Drawing.Size(600,25)
    AutoEllipsis = $true
    BackColor = "#101c28"
}
...
[System.Windows.Forms.CheckBox]$CheckBoxP = @{
    Text = " Apri il file 'carrier.ps1' quando è completato"
    Font = "Verdana, 11"
    AutoSize = $true
...
"@
    ...
    if ($CheckBoxS.Checked) {
        if ($ptext.TextLength -le 6) {
            [System.Windows.Forms.MessageBox]::Show("La password deve avere almeno 6 caratteri", "Errore", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Warning)
            $textBoxPS1.Text = ""
            return
        } else {
...
`$form.Text = "I N S E R I R E   P A S S W O R D"
...
"@
    ...
    if (Test-Path "$($LabelSaveP.Text)") {
        $textBoxPS1.Text = "Salvataggio file 'carrier.ps1' terminato"
        # Apertura del file, se selezionata checkbox
        if ($CheckBoxP.Checked -and $CheckBoxS.Checked) {
            $textBoxPS1.Text = "File creato; se la password è corretta, attendere che venga decifrato e aperto"
            & "$($LabelSaveP.Text)"
        } elseif ($CheckBoxP.Checked) {
            $textBoxPS1.Text = "Salvataggio file 'carrier.ps1' terminato; attendere che venga aperto o controllare errori"
            & "$($LabelSaveP.Text)"
        }
    }
})
